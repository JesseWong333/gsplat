...
cube = np.zeros([2048*2, 1024*2, 128*2])
...
block_mins = block_coords * block_size
...
simplified_mesh = trimesh_mesh.simplify_quadric_decimation(percent=0.7)
# mesh_lap = mesh.filter_smooth_laplacian(number_of_iterations=5, lambda_filter=0.5)
# mesh_lap.compute_vertex_normals()
simplified_mesh.export("./samples/output_mesh.ply")
# o3d.io.write_triangle_mesh("./samples/output_mesh.ply", simplified_mesh)
